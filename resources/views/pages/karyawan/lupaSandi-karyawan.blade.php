            ...
            <div class="w-[40%]">
                ...
                <form>
                    ...
                    <div class="mb-2 w-full flex justify-center">
                        <a href="#">
                            <button type="button" class="block w-full focus:outline-none text-white bg-[#f8d65b] hover:bg-yellow-400 focus:ring-2 focus:ring-yellow-400 font-medium rounded-lg text-sm px-12 py-1.5 me-2 mb-2">Kirim</button>
                        </a>
                    </div>
